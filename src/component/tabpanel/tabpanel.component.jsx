...
const Tabpanel = () => {
  ...
  return (
    <section className='elipse right-elipse mx-auto mt-[5.3rem] h-[46.3rem]  max-w-[110.3rem] text-left'>
        ...
        >
          <figure className=' flex flex-row gap-10 '>
            ...
            <figcaption className='flex flex-col gap-7 pl-[10rem] pt-[5.8rem]'>
              ...
              <button className='btn-primary mt-[1.3rem] self-start'>More info</button>
            </figcaption>
          </figure>
        </article>
      ))}
